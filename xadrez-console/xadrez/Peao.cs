        ...
        public override bool[,] movimentoPossiveis()
        {
            ...
            if (cor == Cor.Branca)
            {
                ...
                if (posicao.linha == 3)
                {
                    ...
                    if (tab.posicaoValida(esquerda) && exiteInimigo(esquerda) && tab.peca(esquerda) == partida.vuneravelEnPassant)
                    {
                        mat[esquerda.linha - 1, esquerda.coluna] = true;
                    }

                    Posicao direita = new Posicao(posicao.linha, posicao.coluna + 1);
                    if (tab.posicaoValida(direita) && exiteInimigo(direita) && tab.peca(direita) == partida.vuneravelEnPassant)
                    {
